...
<body>
   ...
   <h1>Signin</h1>
    ...
    <form action="studentlogin.php" method="POST">
        ...
        <button type="submit"><a href="../../Task4/Student/home.html" style="color:#f4f4f4; text-decoration:none">Login</a></button>
    </form>

    <p>Don't have an account? <a href="studentsignup.html">Signup</a></p>
   </div>
</body>
</html>
